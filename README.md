...
- The supplied ghost animations are mirrored to face right, rasterized into transparent local sprite sheets, and missing/empty source frames are held on the nearest valid pose to prevent flashing.
